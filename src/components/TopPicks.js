...
const TopPicks = () => {
    return (
        <>
            <h1 className="text-orange-700 font-bold text-center text-2xl py-2">Top Picks</h1>
                                ...
                                <SplideSlide key={item.id}>
                                    <div className="rounded-3xl relative">
                                        <div className="absolute w-full h-full bg-black/50 rounded-3xl text-white">
                                            ...
                                            <p>{item.price}</p>
                                            <button className="border border-dotted border-red-500 text-white mx-2 absolute bottom-4">Add To Cart</button>
                                        </div>
